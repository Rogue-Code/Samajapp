...
const en = {
  ...
  "profile.occupationPlaceholder": "Business Owner",
  ...
  "profile.familyAdminQuestion": "Are you the Family Admin?",
  "profile.familyAdminYes": "Yes, I am",
  "profile.familyAdminNo": "No, I'm not",
  ...
  "account.familyAdminStatus": "Family Admin Status",
  "account.familyAdminYes": "Yes, I am Admin",
  "account.familyAdminNo": "No",
  ...
  "facility.removeBookmark": "Remove bookmark",
  "facility.saveFacility": "Save facility",
  "facility.verified": "Verified",
  "facility.email": "Email",
  "facility.website": "Website",
  "facility.address": "Address",
  "facility.openInMaps": "Open in Google Maps",
...
const gu: Partial<Record<StringKey, string>> = {
  ...
  "profile.occupationPlaceholder": "વ્યવસાય માલિક",
  "profile.dob": "જન્મ તારીખ",
  "profile.dobPlaceholder": "દિ / મા / વર્ષ",
  ...
  "profile.familyAdminQuestion": "શું તમે કુટુંબના એડમિન છો?",
  "profile.familyAdminYes": "હા, હું છું",
  "profile.familyAdminNo": "ના, હું નથી",
  ...
  "account.familyAdminStatus": "કુટુંબ એડમિન સ્થિતિ",
  "account.familyAdminYes": "હા, હું એડમિન છું",
  "account.familyAdminNo": "ના",
