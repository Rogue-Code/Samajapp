...
const en = {
  ...
  "account.leaveFamily": "Leave this family",
  "account.pendingApproval": "Waiting for {name} to approve your request",
  "account.cancelRequest": "Cancel request",
  "account.joinFamilyCodeLabel": "Join a family with a code",
  "account.joinFamilyButton": "Send join request",
  "account.becomeFamilyAdmin": "Become a Family Admin instead",
...
const gu: Partial<Record<StringKey, string>> = {
  ...
  "account.leaveFamily": "આ કુટુંબ છોડો",
  "account.pendingApproval": "{name} ની મંજૂરીની રાહ જોવાઈ રહી છે",
  "account.cancelRequest": "વિનંતી રદ કરો",
  "account.joinFamilyCodeLabel": "કોડ વડે કુટુંબમાં જોડાઓ",
  "account.joinFamilyButton": "જોડાવાની વિનંતી મોકલો",
  "account.becomeFamilyAdmin": "તેના બદલે કુટુંબ એડમિન બનો",
